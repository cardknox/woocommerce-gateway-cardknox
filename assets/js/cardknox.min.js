...
document.getElementById("ifieldsError").textContent);return!1},3E4),!1},onCCFormChange:function(){a(".wc-cardknox-error, .xExp").remove()},onCardknoxResponse:function(){var c=a("#cardknox-card-expiry").payment("cardExpiryVal");c=c.month.toString()+c.year.toString().substr(2,2);console.log("onCardknoxResponse");b.form.append("<input type='hidden' class='xExp' name='xExp' value='"+c+"'/>");b.form.submit()},onIfieldloaded:function(){setIfieldStyle("card-number",{border:"0","border-left-color":"rgb(67, 69, 75)",
"font-size":"19.8px",padding:"12.25px",width:"225px",height:"32px","background-color":"rgb(242, 242, 242)","font-weight":"400"});setIfieldStyle("cvv",{border:"0","border-left-color":"rgb(67, 69, 75)","font-size":"19.8px",padding:"12.25px",width:"106px",height:"32px","background-color":"rgb(242, 242, 242)","font-weight":"400"})}};b.init()});
