...
class WC_Gateway_Cardknox_Addons extends WC_Gateway_Cardknox
{
    ...
    protected function get_billing_info($request, $order, $version_comparison)
    {
        ...
        $request['xBillStreet'] = $version_comparison ? $order->billing_address_1 : $order->get_billing_address_1();
        $request['xBillStreet2'] = $version_comparison ? $order->billing_address_2 : $order->get_billing_address_2();
        $request['xBillCity'] = $version_comparison ? $order->billing_city : $order->get_billing_city();
        $request['xBillState'] = $version_comparison ? $order->billing_state : $order->get_billing_state();
        $request['xBillZip'] = $version_comparison ? $order->billing_postcode : $order->get_billing_postcode();
    ...
    protected function get_shipping_info($request, $order, $version_comparison)
    {
        ...
        $request['xShipStreet'] = $version_comparison ? $order->shipping_address_1 : $order->get_shipping_address_1();
        $request['xShipStreet2'] = $version_comparison ? $order->shipping_address_2 : $order->get_shipping_address_2();
        $request['xShipCity'] = $version_comparison ? $order->shipping_city : $order->get_shipping_city();
        $request['xShipState'] = $version_comparison ? $order->shipping_state : $order->get_shipping_state();
        $request['xShipZip'] = $version_comparison ? $order->shipping_postcode : $order->get_shipping_postcode();
        $request['xShipCountry'] = $version_comparison ? $order->shipping_country : $order->get_shipping_country();
