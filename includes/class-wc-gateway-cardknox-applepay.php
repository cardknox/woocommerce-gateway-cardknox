...
class WCCardknoxApplepay extends WC_Payment_Gateway_CC
{
    ...
    public function __construct()
    {
        ...
        $methodDescription .= '<a target="_blank" href="https://portal2.cardknox.com/account-settings/payment-methods">';
        ...
        $this->view_transaction_url = 'https://portal2.cardknox.com/transactions?referenceNumber=%s';
        $this->supports             = array(
            'subscriptions',
            'products',
            'refunds',
